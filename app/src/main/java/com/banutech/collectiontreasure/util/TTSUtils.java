...
import com.banutech.collectiontreasure.app.AppApplication;
...
public class TTSUtils implements InitListener, SynthesizerListener {
    ...
    public void init() {
        ...
        if (CourseUtils.resultProcess("com.banutech.collectiontreasure")) {

            mTts = SpeechSynthesizer.createSynthesizer(AppApplication.getInstance(), this);
            // 清空参数
